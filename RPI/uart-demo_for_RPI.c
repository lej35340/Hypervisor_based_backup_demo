...
{
	unsigned int i = 0;
    printk("JOLE::Assign the address of the GPIO peripheral (Using ARM Physical Address)\n");
	/* Assign the address of the GPIO peripheral (Using ARM Physical Address) */
    gpio = (unsigned int*)GPIO_BASE;
    printk("JOLE::Write 1 to the GPIO16 init nibble in the Function Select 1 GPIO peripheral register to enable GPIO16 as an output )\n");
    /* Write 1 to the GPIO16 init nibble in the Function Select 1 GPIO
       peripheral register to enable GPIO16 as an output */
    gpio[LED_GPFSEL] |= (1 << LED_GPFBIT);

    printk("JOLE::enter while loop)\n");
	/*
